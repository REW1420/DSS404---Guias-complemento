...
if ($_SERVER["REQUEST_METHOD"] == 'POST' && isset($_POST["enviar"])) {
    ...
    <div class="input-group">
    <input type="number" id="horasextras" name="horasextras" maxlength="2" min="0" step="1">
    <label class="label" for="horasextras">Número horas extras</label>
    </div>

    <div class="input-group">
    <input type="number" id="pagohoraextra" name="pagohoraextra" maxlength="6" min="0.00" step=".01">
    <label class="label" for="pagohoraextra">Pago por hora extra</label>
    </div>

    <div class="input-group">
    <input type="number" id="prestamo" name="prestamo" maxlength="6" min="0.00" step=".01">
    <label class="label" for="pagohoraextra">Prestamo</label>
    </div>
