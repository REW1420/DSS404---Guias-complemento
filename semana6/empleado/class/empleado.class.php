...
class empleado
{
    ...
    function obtenerSalarioNeto($nombre, $apellido, $salario, $horasextras, $pagoxhoraextra = 0.0, $prestamo)
    {
    ...
    {
        // Generar la tabla de la boleta de pago con los datos del empleado y los descuentos aplicados
        // Incluye el préstamo en los descuentos si es mayor que cero
        ...
        if ($this->prestamo > 0) {
            $tabla .= "<tr>\n<td>Descuento préstamo: </td>\n";
            $tabla .= "<td>$" . number_format($this->prestamo, 2, '.', '.') . "</td>\n</tr>";
        }
        $tabla .= "<tr>\n<td>Total descuentos: </td>\n";
        $tabla .= "<td>$" . number_format($this->isss + $this->afp + $this->renta + $this->prestamo, 2, '.', '.') . "</td>\n</tr>\n";
